module github.com/desmos-labs/chain-link-tool
...
replace (
	// Desmos wasmd branch is: https://github.com/desmos-labs/wasmd v0.28.x-desmos
	github.com/CosmWasm/wasmd => github.com/desmos-labs/wasmd v0.29.0-desmos.2

	// Desmos cosmos-sdk branch is: https://github.com/desmos-labs/cosmos-sdk v0.45.x-desmos
